          ...
          <div className={landingPageStyles.heroGrid}>
            ...
            <div className={landingPageStyles.heroLeft}>
              ...
              <h1 className={landingPageStyles.heading}>
                <span className={landingPageStyles.headingText}>Create </span>
                <span className={landingPageStyles.headingGradient}>Impactful</span>
          ...
          <div className={landingPageStyles.featuresContainer}>
            <div className={landingPageStyles.featuresHeader}>
              <h2 className={landingPageStyles.featuresTitle}>
                Why Choose <span className={landingPageStyles.featuresTitleGradient}>Resume & Job Hub?</span>
              </h2>
